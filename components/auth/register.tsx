...
const Register = () => {
    ...
    return (
        <form className="max-w-sm m-auto">
            <div className="mb-5">
                <input type="text" id="name" className="bg-transparent border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body" placeholder="Nama Anda" required onChange={(e) => setName(e.target.value)} />
            </div>
            <div className="mb-5">
